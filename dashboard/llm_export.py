...
Deliberately excludes ADELE's own AI Recommendation (Bull/Bear/Judge
...
Generated by ADELE on {generated_at} (underlying data bundle fetched
...
*ADELE is a research/decision-support tool. It never places trades, and
